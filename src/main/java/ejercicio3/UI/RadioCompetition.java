...
public class RadioCompetition {
    ...
    private final Inscripciones servicio;
    public RadioCompetition(Inscripciones servicio) {
    ...
    private void todosLosConcursos() {
        ...
        for (Concurso concurso : servicio.concursosAbiertos()) {
    ...
    private void saveInscription() {
        try {
            ...
            JOptionPane.showMessageDialog(this.contentPane, "Inscripción guardada correctamente");
